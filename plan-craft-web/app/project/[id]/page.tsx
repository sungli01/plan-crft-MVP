    ...
    <div className="h-screen flex flex-col bg-[#fafbfc] dark:bg-[#0a0a0f] overflow-hidden transition-colors">
      ...
      <header className="flex-shrink-0 h-14 bg-white dark:bg-[#12121a] border-b border-gray-200 dark:border-gray-800 flex items-center px-4 gap-3 z-30">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="h-8 px-3 rounded-lg text-xs font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors flex items-center gap-1.5"
            title="프로젝트 삭제"
          >
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-[#16161f] rounded-2xl border border-gray-200 dark:border-gray-800 shadow-2xl max-w-md w-full p-6 animate-in zoom-in-95 duration-200">
            <div className="flex items-start gap-4 mb-6">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-red-500 to-rose-600 flex items-center justify-center flex-shrink-0 shadow-lg shadow-red-500/30">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                  <strong className="text-gray-900 dark:text-white">{project?.title}</strong> 프로젝트를 삭제하시겠습니까?
                  <br />
                  <span className="text-red-600 dark:text-red-400 font-medium">이 작업은 되돌릴 수 없습니다.</span>
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              <button
                ...
                disabled={deleting}
                className="flex-1 py-2.5 px-4 rounded-xl font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors disabled:opacity-50"
              >
                취소
              </button>
              <button
                ...
                disabled={deleting}
                className="flex-1 py-2.5 px-4 rounded-xl font-bold text-white bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 transition-all shadow-lg shadow-red-500/30 disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {deleting ? (
                  <>
